...
if(isset($_POST['submit_e'])){
	...
	$w1="DELETE FROM painting WHERE p_id='".$p_id."'";
	$w2="DELETE FROM painting_details WHERE p_id='".$p_id."'";
...
<div class="add_ex" id="ex1" style="background-color: black">
	<h2 align=center style="text-decoration: underline;color:white;" >DELETE PAINTING DATA</h2>
