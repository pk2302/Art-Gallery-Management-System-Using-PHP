...
$count=mysqli_num_rows($result4);
	...
	$w1 = "DELETE FROM artist where artist_id='".$a_id."'";
	$w2 = "DELETE FROM artist_details where artist_id='".$a_id."'";
	$w3 = "DELETE FROM artist_info where artist_id='".$a_id."'";
...
<div class="add_ex" id="ex1" style="background-color: black">
	<h2 align=center style="text-decoration: underline;color:white;" >DELETE ARTIST DATA</h2>
