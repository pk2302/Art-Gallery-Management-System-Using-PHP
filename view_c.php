...
$sql = "SELECT * FROM customer ,customer_details where customer.c_id=customer_details.c_id order by customer.c_id asc"; 
...
<div class="add_ex" id="ex1">
	<h2 align=center style="text-decoration: underline;" > CUSTOMER DATA</h2>
	<hr><br>
	<table>
			<tr>
			<th>ID</th>
