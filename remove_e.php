...
if(isset($_POST['submit_e'])){
	...
	$w1 = "DELETE FROM exhibition where e_id='".$e_id."'";
	$w2 = "DELETE FROM exhibition_details where e_id='".$e_id."'";
...
<div class="add_ex" id="ex1" style="background-color: black">
	<h2 align=center style="text-decoration: underline;color:white;" >DELETE EXHIBITION DATA</h2>
